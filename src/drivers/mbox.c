...
void print_board_info(uint32_t revision) {
    ...
    if (revision & (1 << 23)) {
        ...
        switch (revision) {
            case 0x2:
                uart_puts("Raspberry Pi B Rev 1.0 (256MB)");
                break;
            case 0x3:
                uart_puts("Raspberry Pi B Rev 1.0 + ECN0001 (256MB)");
                break;
            case 0x4:
                uart_puts("Raspberry Pi B Rev 2.0 (256MB)");
                break;
            case 0x5:
                uart_puts("Raspberry Pi B Rev 2.0 (256MB)");
                break;
            case 0x6:
                ...
                break;
            case 0x7:
                uart_puts("Raspberry Pi A (256MB)");
                break;
            case 0x8:
                uart_puts("Raspberry Pi A (256MB)");
                break;
            case 0x9:
                ...
                break;
            case 0xd:
                uart_puts("Raspberry Pi B Rev 2.0 (512MB)");
                break;
            case 0xe:
                uart_puts("Raspberry Pi B Rev 2.0 (512MB)");
                break;
            case 0xf:
                ...
                break;
            case 0x10:
                uart_puts("Raspberry Pi B+ (512MB)");
                break;
            case 0x11:
                uart_puts("Raspberry Pi Compute Module (512MB)");
                break;
            case 0x12:
                uart_puts("Raspberry Pi A+ (256MB)");
                break;
